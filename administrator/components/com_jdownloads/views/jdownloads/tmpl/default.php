            ...
            <div class="well">
                <?php 
                    ...
                    if (!is_dir($jlistConfig['files.uploaddir']) &&  $jlistConfig['files.uploaddir'] != ''){ ?>
                        <div style="align:left; padding: 5px; margin:10px; border-style: solid; border-width: thin;"><font color="red"><b><?php echo JText::sprintf('COM_JDOWNLOADS_AUTOCHECK_DIR_NOT_EXIST', $jlistConfig['files.uploaddir']).'</b><br /><br />'.JText::_('COM_JDOWNLOADS_AUTOCHECK_DIR_NOT_EXIST_2'); ?></b></font></div> 
                <?php }  ?>
