...
defined('_JEXEC') or die;
    ...
    if ($files){
        ...
        for ($i=0; $i<count($files); $i++) {
            ...
            if ($sum_char > 0){
                $total = strlen($files[$i]->file_title) + strlen($files[$i]->release) + strlen($short_version) +1;
                if ($total > $sum_char){
            ...
            $rating_value ='
                    ...
                    <li id="rating'.$files[$i]->file_id.'" class="current-rating" style="width:'.$files[$i]->ratenum.'%;"></li>
                    ...
                    <div id="jwajaxvote'.$files[$i]->file_id.'" class="jwajaxvote-box">
                    ';
