...
?>">
          ...
          <div class="container">
			<header class="header row" role="banner">
				<div class="header-inner clearfix">
					<a class="pull-left col-sm-9 col-xs-10" href="<?php echo $this->baseurl; ?>/">
						<?php echo $logo; ?>
	...
	<footer class="footer" role="contentinfo">
     ...
     <!-- <div class="copyright">
       ...
       <div class="copyright">
      		<p style="text-align: center;">&copy; <?php echo date('Y'); ?> Signs Full Joint Tech. Co., Ltd. All rights reserved. </p>
         <p style="text-align: center;"> Designed by <a style="text-decoration: underline;" href="http://bmbc.co/index.php/en/">BMBC Premium Solutions.</a></p>
      </div> 
	</footer>
