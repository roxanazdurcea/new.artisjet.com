                ...
                <fieldset class="jd_fieldset_outer">
                   ...
                   if ($rules->form_select_main_file):?> 
                        <div class="formelm70">
                         ...
                         <div class="formelm30">
                            <?php echo '<small>'.JText::_('COM_JDOWNLOADS_BACKEND_FILESEDIT_ALLOWED_FILETYPE').'<br />'.str_replace(',', ', ', $rules->uploads_allowed_types).'</small><br />'; ?>
                   ...
                   <?php if ($rules->form_file_date):?> 
                    ...
                    <?php if ($rules->form_select_preview_file):?>            
                        ...
                        <div class="formelm30">
                            <?php echo '<small>'.JText::_('COM_JDOWNLOADS_BACKEND_FILESEDIT_ALLOWED_FILETYPE').'<br />'.str_replace(',', ', ', $rules->uploads_allowed_preview_types).'</small><br />'; ?>
                            <?php echo '<small>'.JText::_('COM_JDOWNLOADS_BACKEND_FILESEDIT_ALLOWED_MAX_SIZE').' '.$rules->uploads_maxfilesize_kb.' KB</small>'; ?>
                        </div>        
                    <?php endif;?>                                        
