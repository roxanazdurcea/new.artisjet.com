   ...
   <?php if (($showEmptyMonth) || (!$showEmptyMonth && !empty($postCounts->$i->$m))) { ?>
		...
		<?php } else { ?>
				<div class="eb-mod-item">
					<a class="eb-mod-media-thumb" href="<?php echo EBR::_('index.php?option=com_easyblog&view=calendar&year='.$i.'&month='.$m ); ?>" <?php if($defaultYear == $i && $defaultMonth == $m) echo 'style="font-weight:700;"'; ?>>
						<?php echo $curDate->toFormat('%B'); ?>
