...
<div id="fd" class="eb eb-mod mod-easyblogshowcase<?php echo $params->get('moduleclass_sfx'); ?>">
	<div class="mod-easyblogshowcase st-1 eb-gallery" data-autoplay="<?php echo $autoplay;?>" data-interval="<?php echo $autoplayInterval;?>">
	    ...
	    <div class="eb-gallery-menu">
	    	<?php $i = 0; ?>
	    	<?php foreach ($posts as $post) { ?>
		    	<div class="eb-gallery-menu-item active">
